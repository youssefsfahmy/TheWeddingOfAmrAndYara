...
const Head: React.FC<HeadProps> = ({ children }) => {
  ...
  return (
    <NextHead>
      <title>{"Yara and Amr are getting married!"}</title>
      <meta property="og:type" content="website" />
      <meta property="og:title" content={"Yara and Amr are getting married!"} />
      <meta itemProp="name" content={"Yara and Amr are getting married!"} />
